    ...
    <div>
      ...
      >
        <div className="flex flex-col items-center mb-8 px-0">
          <h2 className="text-4xl md:text-5xl font-playfair font-bold uppercase tracking-wide text-center">
            GET SOCIAL WITH US
          </h2>
          <div className="h-2 w-20 bg-[#FF8800] mt-4" />
        </div>
        <motion.div
          className="flex flex-row gap-8 mt-4 mb-8 justify-center"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          variants={{
      ...
      >
        <Swiper
          ...
          loop={true}
          className="w-full social-swiper"
